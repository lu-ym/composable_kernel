...
// ADataType and BDataType can be tf32_t for TF32 mode - auto-detection happens internally
                                            ...
                                            const CLayout c_layout = CLayout{})
{
    ...
    // Map tf32_t to float for AccDataType lookup
    ...
    using AccDataType = typename GemmTypeConfig<ADataTypeBuf, BDataTypeBuf, CDataType>::AccDataType;
    ...
    if(test_async)
    {
        ...
        // Pass original types (ADataType, BDataType) to invoker for tf32 auto-detection
        ...
        const auto rtol_atol =
            calculate_rtol_atol<ADataTypeBuf, BDataTypeBuf, AccDataType, CDataType>(
